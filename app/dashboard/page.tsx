      ...
      <main className="relative z-10 max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 mb-12"
          ...
          <div className="shrink-0 relative">
            ...
            <div className="absolute left-1/2 -translate-x-1/2 bottom-2 w-16 h-4 rounded-full"
              style={{ background: "radial-gradient(ellipse, rgba(255,59,48,0.4) 0%, transparent 70%)", filter: "blur(4px)", animation: "pulseGlow 3s ease-in-out infinite" }} aria-hidden />
          </div>
          <div>
