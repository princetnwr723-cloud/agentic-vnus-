...
// ── Skills list ────────────────────────────────────────────
const SKILLS = [
  { name: "Email Agent",    desc: "Clear inbox, send & reply to emails automatically" },
...
function WorkspaceCard({
  ...
  const osLower = workspace.os.toLowerCase();
...
function PlanUsageCard({
  ...
  return (
    <div
      ...
      style={{ background: `${plan.color}08`, borderColor: `${plan.color}30` }}
    >
      ...
      <div className="mb-1.5">
        <div className="flex items-center justify-between mb-1">
          ...
          <span className="text-gray-400 text-xs">
            {fmtTokens(tokensUsed)} / {fmtTokens(plan.tokenLimit)}
          </span>
        </div>
      ...
      <header className="relative z-10 nav-blur border-b border-white/5 sticky top-0">
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <a href="/" className="flex items-center gap-2 group">
            ...
            <span className="font-bold text-white text-sm group-hover:text-[#FF3B30] transition-colors">
              Vnus AI
            </span>
          </a>
              ...
              {dropdownOpen && (
                ...
                >
                  <div className="px-4 py-3 border-b border-white/5">
                    ...
                    {userData?.profession && (
                      <p className="text-gray-500 text-xs mt-0.5">{userData.profession}</p>
                    )}
                  </div>
                  <button
                    onClick={() => { setDropdownOpen(false); setPricingOpen(true); }}
      ...
      <main className="relative z-10 max-w-6xl mx-auto px-6 py-10">
        ...
        >
          <div className="shrink-0 relative">
            ...
            <div
              ...
              style={{
                background: "radial-gradient(ellipse, rgba(255,59,48,0.4) 0%, transparent 70%)",
                filter:     "blur(4px)",
          ...
          {workspaces.length === 0 ? (
            <div className="rounded-xl border border-dashed border-white/10 p-8 text-center">
              ...
              <p className="text-gray-600 text-xs mb-4">
                Set up the agent on your PC, then enter the 10-digit code here.
              </p>
        ...
        >
          {[
            ...
            { label: "PCs Connected",  value: String(workspaces.length) },
          ].map((s) => (
            <div key={s.label} className="glass-card rounded-xl p-4 flex items-center gap-3">
              <div className="w-9 h-9 rounded-lg bg-[#FF3B30]/8 border border-[#FF3B30]/15 flex items-center justify-center shrink-0">
        ...
        <div style={{ opacity: visible ? 1 : 0, transition: "opacity 0.6s ease 0.3s" }}>
          ...
          <p className="text-gray-500 text-sm mb-5">
            These skills activate once your agent is connected.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {SKILLS.map((skill, i) => (
              <div
                ...
                style={{
                  opacity:    visible ? 1 : 0,
                  transition: `opacity 0.5s ease ${0.35 + i * 0.06}s`,
                }}
              >
                ...
                <div className="w-11 h-11 rounded-xl bg-[#FF3B30]/8 border border-[#FF3B30]/15 flex items-center justify-center mb-4 group-hover:bg-[#FF3B30]/14 transition-all">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#FF3B30" strokeWidth="1.8" strokeLinecap="round">
                    <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/>
                  </svg>
                </div>
