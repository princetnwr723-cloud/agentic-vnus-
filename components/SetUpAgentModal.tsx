            ...
            {tab === "download" ? (
              <div className="pb-5">
                ...
                <div className="space-y-2 mb-5">
                  {[
                    "Download agent for your OS",
                    "Install and grant permissions",
                    "Copy the 10-digit code shown",
                    "Paste it in Add Workspace",
                  ].map((text, i) => (
                ...
                <div className="space-y-2.5">
                  ...
                  <a href={DOWNLOAD_LINKS.windows}
                    ...
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#666" strokeWidth="2.5" strokeLinecap="round" className="group-hover:stroke-[#FF3B30] transition-colors">
                  ...
                  <a href={DOWNLOAD_LINKS.mac}
                    ...
                    <div className="flex-1 text-left">
                      ...
                      <p className="text-gray-500 text-xs">Intel Mac · macOS 12+</p>
                    </div>
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#666" strokeWidth="2.5" strokeLinecap="round" className="group-hover:stroke-[#FF3B30] transition-colors">
                      <path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4M7 10l5 5 5-5M12 15V3"/>
                    </svg>
                  ...
                  {/* Mac Apple Silicon */}
                  <a href={DOWNLOAD_LINKS.macArm}
                    className="w-full flex items-center gap-3 px-4 py-3 rounded-xl border border-white/10 bg-white/4 hover:bg-white/8 hover:border-[#FF3B30]/30 transition-all group">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                      <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z" fill="#bbb"/>
                    </svg>
                    <div className="flex-1 text-left">
                      <p className="text-white text-sm font-semibold">Download for macOS</p>
                      <p className="text-gray-500 text-xs">Apple Silicon · M1 / M2 / M3</p>
                    </div>
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#666" strokeWidth="2.5" strokeLinecap="round" className="group-hover:stroke-[#FF3B30] transition-colors">
                      <path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4M7 10l5 5 5-5M12 15V3"/>
                    </svg>
                  ...
                  <a href={DOWNLOAD_LINKS.linux}
                    ...
                    <div className="flex-1 text-left">
                      ...
                      <p className="text-gray-500 text-xs">AppImage · Ubuntu, Fedora, Debian</p>
                    </div>
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#666" strokeWidth="2.5" strokeLinecap="round" className="group-hover:stroke-[#FF3B30] transition-colors">
                      <path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4M7 10l5 5 5-5M12 15V3"/>
                    </svg>
              ...
              <div className="pb-5">
                ...
                <div className="flex gap-2">
                  {[
                    ...
                    { label: "Copy Link", icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#FF3B30" strokeWidth="2.5" strokeLinecap="round"><path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71"/></svg> },
                  ].map((s) => (
                    <button key={s.label}
                      onClick={s.label === "Copy Link" ? handleCopy : undefined}
