  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse at 50% 50%, rgba(255,59,48,0.06) 0%, transparent 70%)",
        }}
        aria-hidden
      />
      ...
      <p className="text-gray-400 text-lg max-w-xl mx-auto mb-10 leading-relaxed">
        Join thousands of people who let Vnus handle the mundane so they can focus on what
        actually matters.
      </p>
      ...
      <p className="text-gray-600 text-sm mt-6">No credit card required · Works in 5 minutes · Runs on your machine</p>
    </section>
  );
}